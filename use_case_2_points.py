...
player0_axis = (
    lambda: not pc.get_player(0).is_alive(),
    lambda: pc.get_player(0).is_alive())
player1_axis = (
    lambda: not pc.get_player(1).is_alive(),
    lambda: pc.get_player(1).is_alive())
player2_axis = (
    lambda: not pc.get_player(2).is_alive(),
